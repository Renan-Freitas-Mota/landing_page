    ...
    <footer className="border-t border-border/50 py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Acesso às mesmas criptomoedas dos grandes fundos globais. 
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p className="mb-2">
            © 2025 Carteira dos Tubarões. Todos os direitos reservados.
          </p>
          <p className="text-xs">
            Este site não é afiliado ao Facebook, Google, Instagram ou qualquer outra plataforma mencionada. 
            Os resultados podem variar de pessoa para pessoa. Investimentos em criptomoedas envolvem riscos.
          </p>
        </div>
      </div>
    </footer>
